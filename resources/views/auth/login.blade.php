...
<body class="bg-gradient-to-br from-blue-900 via-blue-800 to-blue-700 min-h-screen flex items-center justify-center">
    <div class="bg-white rounded-lg shadow-2xl p-8 w-full max-w-md">
        <div class="text-center mb-8">
            <h1 class="text-3xl font-bold text-gray-900 mb-2">Fiber Core Management</h1>
        ...
        <div class="mt-6 text-center text-sm text-gray-600">
            ...
            <div class="mt-2 space-y-1">
                <p><strong>Super Admin:</strong> superadmin@fiber.com / password</p>
                <p><strong>Regional Admin:</strong> jakarta@fiber.com / password</p>
            </div>
        </div>
    </div>
</body>
