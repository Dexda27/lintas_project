                    ...
                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                        <div class="flex space-x-2">
                            ...
                            @if($closure->core_connections_count == 0)
                                <button type="button"
                                    onclick="confirmDelete('{{ $closure->id }}', '{{ $closure->name }}', '{{ $closure->closure_id }}')"
    ...
    <div class="bg-white rounded-lg shadow-xl max-w-md w-full mx-4">
        <div class="p-6">
            <div class="flex items-center mb-4">
                ...
                <div>
                    <h3 class="text-lg font-semibold text-gray-900">Delete Joint Closure</h3>
                </div>
            </div>

            <div class="mb-6">
                <p class="text-gray-600 mb-2">Are you sure you want to delete this joint closure?</p>
...
function confirmDelete(closureId, closureName, closureIdText) {
...
function executeDelete() {
    if (currentClosureId) {
        ...
        form.action = `{{ route('closures.index') }}/${currentClosureId}`;
        form.submit();
    }
}
