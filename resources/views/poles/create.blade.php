...
@section('title', 'Tambah Tiang Baru')
...
<div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    <div class="mb-8">
        <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            <div>
                <h1 class="text-2xl font-bold text-gray-900">Tambah Tiang Baru</h1>
                <p class="text-sm text-gray-500 mt-1">Buat data tiang fiber optik baru</p>
            </div>
            ...
            <div class="p-6">
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div>
                        ...
                        <input type="text"
                               class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 @error('pole_id') border-red-500 @enderror"
                               id="pole_id"
                               name="pole_id"
                               value="{{ old('pole_id') }}"
                               placeholder="Contoh: TIANG-BALI-0001"
                               required
                               autocomplete="off">
                        <p class="mt-1 text-xs text-gray-500">Masukkan ID unik untuk tiang ini</p>
                        @error('pole_id')
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    ...
                    <div>
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 @error('type') border-red-500 @enderror"
                            ...
                            <option value="besi" {{ old('type') == 'besi' ? 'selected' : '' }}>Besi</option>
                            <option value="beton" {{ old('type') == 'beton' ? 'selected' : '' }}>Beton</option>
                        </select>
                        @error('type')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    ...
                    <div>
                        ...
                        <select class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-gray-900 focus:border-gray-900 @error('height') border-red-500 @enderror"
                            ...
                            <option value="7" {{ old('height') == '7' ? 'selected' : '' }}>7 meter</option>
                            <option value="9" {{ old('height') == '9' ? 'selected' : '' }}>9 meter</option>
                        </select>
                        @error('height')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
