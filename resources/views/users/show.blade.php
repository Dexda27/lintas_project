                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between py-2 border-b border-gray-200">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">{{ $user->created_at->format('M d, Y \a\t g:i A') }}</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between py-2 border-b border-gray-200">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">{{ $user->updated_at->format('M d, Y \a\t g:i A') }}</p>
                        </div>
                    ...
                    @if($user->email_verified_at)
                        <div class="flex items-center justify-between py-2">
                            <div>
                                ...
                                <p class="text-sm text-gray-500">{{ $user->email_verified_at->format('M d, Y \a\t g:i A') }}</p>
                            </div>
                            <div class="text-green-600">
                                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 20 20">
